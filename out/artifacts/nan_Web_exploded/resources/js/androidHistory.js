...
$(document).ready(function() {
    ...
    $.ajax({
        ...
        data:{'apkKeyWord':$("#apkKeyWord").val()},
        url: "/historylist",
        ...
        // $.post("/historylist", {"apkKeyWord": $("#apkKeyWord").val()}, function (data) {
        // });
    }

    $("#historypackaging").click(function () {

         $.post("/androidHistory", {"pid": $("#pid").val(), "historypackaging": true}, function (data) {
        ...
        for(var i=0 ; i<listCount;i++) {
            ...
            if (j < info.length) {
                apklist1 = "<tr>"
                    ...
                    + "<td data-title='版本号'>" + info[j].branches + "</td>"
